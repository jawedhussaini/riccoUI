...
const imageBoxStyles = `relative h-72 w-full  before:bg-contain bg-no-repeat before:absolute before:z-10 before:h-full before:w-full 
...
const iconStyles = `transition-all duration-300 text-red hover:text-gray-450`;
  ...
  return (
    <div className="grid gap-10 xl:grid-cols-2 2xl:grid-cols-3">
      ...
      <div className="flex cursor-pointer flex-col">
        <div
          className={`${imageBoxStyles} before:bg-[url('./images/trainers/dd.png')]`}
        ></div>
        <div className={textBoxStyles}>
          <FaAngleUp className="absolute right-1/2 top-[-13px] z-10 text-red translate-x-1/2 text-xl" />
          <h4 className="text-2xl text-red font-bold">Alex Lewis</h4>
      ...
      <div className="flex cursor-pointer flex-col">
        <div
          className={`${imageBoxStyles} before:bg-[url('./images/trainers/cc.png')]`}
        ></div>
        <div className={textBoxStyles}>
          <FaAngleUp className="absolute right-1/2 top-[-13px] text-red z-10 translate-x-1/2 text-xl" />
          <h4 className="text-2xl text-red font-bold">Joun Doe</h4>
      ...
      <div className="flex cursor-pointer flex-col xl:col-span-2 xl:w-1/2 xl:justify-self-center 2xl:col-span-1 2xl:w-full">
        <div
          className={`${imageBoxStyles} before:bg-[url('./images/trainers/bb.png')]`}
        ></div>
        <div className={textBoxStyles}>
          <FaAngleUp className="absolute right-1/2 top-[-13px] z-10 text-red translate-x-1/2 text-xl" />
          <h4 className="text-2xl text-red font-bold">Anna Boro</h4>
