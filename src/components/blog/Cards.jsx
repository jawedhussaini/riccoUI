      ...
      <div className="perspective group h-72">
        <div className={`${cardStyles} group-hover:rotate-y-180`}>
          ...
          <div className={frontStyles.card}>
            ...
            <h4 className="font-bold text-red">Yoga For Everyone in 2022</h4>
          ...
          {/* Back */}
          <div
            className={`${backStyles.card} rotate-y-180 bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('./images/blog/aa.jpg')]`}
          >
      ...
      <div className="perspective group h-72">
        <div className={`${cardStyles} group-hover:rotate-y-180`}>
          ...
          <div className={frontStyles.card}>
            ...
            <h4 className="font-bold  text-red">Back Into CrossFit After Vacation</h4>
            <p className="text-sm font-medium text-gray-300">
              Authoritatively disseminate multimedia based total linkage through
              market-driven methodolContinually transform
            </p>
          ...
          {/* Back */}
          <div
            className={`${backStyles.card} rotate-y-180 bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('./images/blog/bb.jpg')]`}
          >
      ...
      <div className="perspective group h-72 xl:col-span-2 xl:w-1/2 xl:justify-self-center 3xl:col-span-1 3xl:w-full">
        <div className={`${cardStyles} group-hover:rotate-y-180`}>
          ...
          <div className={frontStyles.card}>
            ...
            <h4 className="font-bold  text-red">Meet Fitness Ambassador Grace</h4>
            <p className="text-sm font-medium text-gray-300">
              Authoritatively disseminate multimedia based total linkage through
              market-driven methodolContinually transform
            </p>
          ...
          {/* Back */}
          <div
            className={`${backStyles.card} rotate-y-180 bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('./images/blog/cc.jpg')]`}
          >
