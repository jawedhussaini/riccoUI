    ...
    <div className="mb-20 grid items-center gap-10 px-10 text-center md:grid-cols-2 md:gap-6">
      <div className="flex items-center justify-center gap-4">
        <img
          src={training}
          alt=""
          className="w-16 rounded-full bg-gray-550 p-2 transition-all duration-700 hover:shadow-2xl "
        />
        <h4 className="basis-32 text-lg font-bold text-red capitalize">
      ...
      <div className="flex items-center justify-center gap-4">
        <img
          ...
          className="w-16 rounded-full bg-gray-550 p-2 transition-all duration-700 hover:shadow-2xl"
        />
        <h4 className="basis-32 text-lg text-red font-bold capitalize ">
