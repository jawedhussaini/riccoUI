import img from "../../images/choose-us/aa.jpg";
import play from "../../images/choose-us/play.png";

function Image() {
  return (
    <div className="relative flex before:absolute before:bottom-0 before:left-3 before:h-64 before:w-3 after:absolute after:bottom-0 after:right-8 after:top-[-30px] after:w-3 after:rotate-[-6deg]">
